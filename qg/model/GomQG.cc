...
// -----------------------------------------------------------------------------
GomQG::GomQG(const Locations_ & locs, const GomQG & other,
...
// The QG model cannot handle locations sampled with more than one method yet.
  ...
  qg_gom_copy_f90(keyGom_, other.keyGom_);  // just for allocating to same size
  qg_gom_analytic_init_f90(keyGom_, locs.samplingMethod(0).sampledLocations(), initConf);
}
// -----------------------------------------------------------------------------
