...
// -----------------------------------------------------------------------------
  SECTION("test_ObsVec1D_constructor") {
    boost::scoped_ptr<lorenz95::ObsVec1D> ov(new lorenz95::ObsVec1D(*f.obstable_, *f.vars_));
    EXPECT(ov.get() != NULL);
    for (unsigned int ii = 0; ii < f.obstable_->nobs(); ++ii) {
      EXPECT((*ov)(ii) == 0.0);
    }
  }
// -----------------------------------------------------------------------------
  SECTION("test_ObsVec1D_nobs") {
    boost::scoped_ptr<lorenz95::ObsVec1D> ov(new lorenz95::ObsVec1D(*f.obstable_, *f.vars_));
    EXPECT(ov->nobs() == f.obstable_->nobs());
  }
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
  SECTION("test_ObsVec1D_copy_constructor_copy") {
    boost::scoped_ptr<lorenz95::ObsVec1D> ov1(new lorenz95::ObsVec1D(*f.obstable_, *f.vars_));
    ov1->read("ObsValue");
...
// -----------------------------------------------------------------------------
  SECTION("test_ObsVec1D_assignment") {
    boost::scoped_ptr<lorenz95::ObsVec1D> ov1(new lorenz95::ObsVec1D(*f.obstable_, *f.vars_));
    ov1->read("ObsValue");
    boost::scoped_ptr<lorenz95::ObsVec1D> ov2(new lorenz95::ObsVec1D(*f.obstable_, *f.vars_));
