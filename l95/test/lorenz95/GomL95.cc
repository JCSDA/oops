...
// -----------------------------------------------------------------------------
  BOOST_AUTO_TEST_CASE(test_GomL95_constructor) {
    boost::scoped_ptr<lorenz95::GomL95> gom(new lorenz95::GomL95(*ot_, *novar_, *t1_, *t2_));
...
// -----------------------------------------------------------------------------
  BOOST_AUTO_TEST_CASE(test_gomL95_dot_product_with) {
    boost::scoped_ptr<lorenz95::GomL95> gom1(new lorenz95::GomL95(*ot_, *novar_, *t1_, *t2_));
    gom1->zero();
    boost::scoped_ptr<lorenz95::GomL95> gom2(new lorenz95::GomL95(*ot_, *novar_, *t1_, *t2_));
    gom2->zero();
