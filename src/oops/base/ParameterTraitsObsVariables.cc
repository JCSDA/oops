...
boost::optional<ObsVariables> ParameterTraits<ObsVariables>::get(util::CompositePath &path,
...
void ParameterTraits<ObsVariables>::set(eckit::LocalConfiguration &config,
    const std::string &name,
...
ObjectJsonSchema ParameterTraits<ObsVariables>::jsonSchema(const std::string &name) {
