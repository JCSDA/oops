...
#ifndef OOPS_ASSIMILATION_RINVMATRIX_H_
#define OOPS_ASSIMILATION_RINVMATRIX_H_
 ...
 public:
  ...
  void multiply(const Dual_ & dx, Dual_ & dy) const {
    ...
    for (unsigned jj = 0; jj < j_.nterms(); ++jj) {
      dy.append(j_.jterm(jj).multiplyCoInv(*dx.getv(jj)));
    }
  }
...
#endif  // OOPS_ASSIMILATION_RINVMATRIX_H_
