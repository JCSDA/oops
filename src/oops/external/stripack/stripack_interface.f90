...
use stripack_mod, only: trmesh, trfind
...
subroutine stripack_trmesh_c(c_num_nodes, c_xs, c_ys, c_zs, &
    c_list, c_lptr, c_lend, c_lnew, c_near, c_next, c_dist) &
...
call trmesh(c_num_nodes, c_xs, c_ys, c_zs, c_list, c_lptr, c_lend, c_lnew, c_near, c_next, c_dist)
