...
!----------------------------------------------------------------------
subroutine vbal_blk_alloc(vbal_blk,nam,geom,bpar,hdata,iv,jv)
...
! Allocation
allocate(vbal_blk%auto(hdata%nc2b,geom%nl0,geom%nl0))
allocate(vbal_blk%cross(hdata%nc2b,geom%nl0,geom%nl0))
allocate(vbal_blk%auto_inv(hdata%nc2b,geom%nl0,geom%nl0))
allocate(vbal_blk%reg(hdata%nc2b,geom%nl0,geom%nl0))
