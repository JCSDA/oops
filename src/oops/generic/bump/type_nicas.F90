...
if ((ens%ne>0).and.(trim(nam%method)/='cor').and.(trim(nam%method)/='cov')) then
...
do its=1,nam%nts
   ...
   do iv=1,nam%nv
      ...
      if ((ens%ne>0).and.(trim(nam%method)/='cor').and.(trim(nam%method)/='cov')) call io%fld_write(mpl,nam,geom,filename, &
