...
do il0=1,sdata%nl0
   call ncerr(subr,nf90_get_var(ncid,tmask_id,tmask(:,:,il0),(/1,1,nam%levs(il0),1/),(/sdata%nlon,sdata%nlat,1,1/)))
...
real(kind_real) :: fld_tmp(sdata%nc0),fld_loc(sdata%nlon,sdata%nlat)
