...
namespace oops {
extern "C" {
  void create_nicas_f90(int &, const eckit::Configuration * const *, const int &, const int *,
                        const int &, const double *, const double *, const int &, const double *, const double *, const int *);
